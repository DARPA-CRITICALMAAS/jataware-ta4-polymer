// See https://github.com/openlayers/openlayers/issues/16004
...
import { all, always, focusWithTabindex } from "ol/events/condition.js";
...
class MouseWheelZoom extends Interaction {
  ...
  handleEvent(mapBrowserEvent) {
    ...
    // This is removed to stop trackpad zooming from panning the map.
    // const view = map.getView();
    // if (
    //   this.mode_ === "trackpad" &&
  ...
  /**
   * If useAnchor is true, the interaction zooms around the given coordinate instead of the mouse
   * position. Set to undefined to revert to using the mouse coordinate as anchor.
