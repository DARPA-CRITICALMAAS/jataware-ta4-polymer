...
import { determineMapSourceURL, getColorForProvenance, valuetext, handleOpacityChange, getLayerById, provenance_mapper } from "./helpers"
...
function SmallProjectionClipped({ cog_id, proj_info, clippedState, baseMapSources, parentBaseMap, crs_names }) {
