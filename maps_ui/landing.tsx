...
function Landing() {
    ...
    const paginateMaps = async () => {
        try {
            ...
            var data = {
                ...searchParams,
                multi_polygons_intersect: { 'coordinates': convertedGeojsonFeature.geometry.coordinates, 'type': 'MultiPolygon' },
            ...
            <>
                <div className="Landing2" >
                    <div className="header">
                        <h1 className="title">Find Maps</h1>
    ...
    return (
        <div key={item.map_id} style={{ color: "black", backgroundColor: returnRowColor(item), border: '1px solid black', padding: '4px', borderRadius: '5px', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ marginTop: 'auto', display: 'flex', justifyContent: 'space-evenly' }}>
                ...
                <Button size="small" variant="contained" onClick={() => { handleMapClick(item, "swatchannotation") }}>Legend Annotations</Button>
